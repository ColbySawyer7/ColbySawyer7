...
| Rusty API              | This API implementation in Rust serves as a boilerplate for deploying Ollama interfacing chatbots, automations, etc. Includes Dockerfile and Docker Compose for quick deployment.  | Rust | Ollama, LLMs | Docker, Linux, Web |
